...
const Projects = () => {
  const projectData = {
    ...
    description:
      "A landmark initiative developed by ZongoVation Capital in partnership with the Government of Ghana to address the country's 1.8 million-unit housing deficit using Shariah-compliant, project-tied financing.",
    metrics: [
      {
        icon: TrendingUp,
        value: "USD 1 Billion",
  ...
  const imageCards = [
    {
      ...
      description:
        "Building modern web and mobile applications with React, Node.js, and Next.js.",
    ...
    },
    {
      ...
      description:
        "Deploying scalable cloud solutions on AWS, Azure, and Google Cloud with CI/CD pipelines.",
      gradient: "from-emerald-500 to-green-600",
    },
    {
      ...
      description:
        "Capturing moments and stories through professional photography, videography, and digital editing.",
      gradient: "from-blue-500 to-cyan-600",
    },
    {
      ...
      description:
        "Celebrating excellence in innovation, creativity, and outstanding project achievements.",
      gradient: "from-purple-500 to-pink-600",
    },
  ];
          ...
          {projectData.metrics.map((metric, index) => (
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-primary-blue to-primary-dark backdrop-blur-sm border border-primary-blue/20 rounded-2xl p-6 text-center transition-all duration-500 overflow-hidden hover:shadow-2xl hover:border-primary-blue/40">
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${metric.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
                />

                {/* Animated Border Glow */}
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-r ${metric.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                >
